return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>tw", function() trouble.toggle("workspace_diagnostics") end, { silent = true, noremap = true })
        vim.keymap.set("n", "<leader>td", function() trouble.toggle("document_diagnostics") end, { silent = true, noremap = true })
        ...
        vim.keymap.set("n", "<leader>tu", function() trouble.next({skip_groups=  true, jump = true}) end, { silent = true, noremap = true })
        vim.keymap.set("n", "<leader>tu", function() trouble.previous({skip_groups=  true, jump = true}) end, { silent = true, noremap = true })
